...
def create_user(user: UserCreate):
    ...
    try:
        cursor.execute('''INSERT INTO users (first_name, last_name, phone, DNI, age, sex, username, email, password, role_id, date_created) 
                          VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, NOW())''',
                       (user.first_name, user.last_name, user.phone, user.DNI, user.age, user.sex, user.username, user.email, hashed_password, user.role_id))
        conn.commit()
